...
public class Customer extends User implements Serializable
{
  ...
  public boolean setTimeNotShow(int aTimeNotShow)
  {
    boolean wasSet = false;
    timeNotShow = aTimeNotShow;
    wasSet = true;
    return wasSet;
  }

  public boolean resetTimeNotShow()
  {
    boolean wasReset = false;
    timeNotShow = getDefaultTimeNotShow();
    wasReset = true;
    return wasReset;
  }

  public int getTimeNotShow()
  {
    return timeNotShow;
  }
  /* Code from template attribute_GetDefaulted */
  public int getDefaultTimeNotShow()
  {
    return 0;
  }
  ...
  public String toString()
  {
    return super.toString() + "["+
            "timeNotShow" + ":" + getTimeNotShow()+ "]" + System.getProperties().getProperty("line.separator") +
